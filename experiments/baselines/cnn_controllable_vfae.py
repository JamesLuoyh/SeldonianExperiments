...
class PytorchCNNLMIFR(SupervisedPytorchBaseModel):
    ...
    def train(self, X_train, Y_train, batch_size, num_epochs):
        ...
        lrl_l = [1e-4, 1e-3]#[1e-3,1e-4]
        lr_l = [1e-4, 1e-3]
        num_epochs_l = [10]#,5,10]#10, 20, 30, 60, 90]
                    ...
                    for lagrangian_elbo in lagrangian_elbo_l:
                        for num_epochs in num_epochs_l:
                            ...
                            for epoch in range(num_epochs):
                                for i, (features, sensitive, semi_labels, labels) in enumerate(trainloader):
                                    ...
                                    if True:
                                        ...
                                        # self.lagrangian.data.add_(self.lr_l * self.lagrangian.grad.data)
                                        # self.lagrangian.grad.zero_()
                            ...
                            if self.use_validation:
                                ...
                                df = pd.read_csv('/media/yuhongluo/SeldonianExperimentResults/cnn_ablation.csv')
                                ...
                                df.to_csv('/media/yuhongluo/SeldonianExperimentResults/cnn_ablation.csv', index=False)
