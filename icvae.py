...
from seldonian.models.pytorch_icvae import PytorchICVAE
...
if __name__ == "__main__":
    ...
    model = PytorchICVAE(device, **{"x_dim": x_dim,
        "s_dim": 1,
        "y_dim": 1,
        "z1_enc_dim": 100,
        "z2_enc_dim": 100,
    ...
    spec_save_name = os.path.join(
        save_dir, f"icvae_{dataname}_mutual_information_{epsilon}.pkl"
    )
